...
- Explorer transaction links use `https://explore.tempo.xyz/tx/{transactionHash}`. Tempo Explorer may expose a separate receipt view from the transaction page when it can decode one.
